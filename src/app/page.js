...
export default async function Home({ searchParams }) {
  ...
  return (
    <main className={styles.grid}>
      ...
      {prev && <Link className={styles.links} href={{ pathname: '/', query: { page: prev, q: searchTerm } }}>Página Anterior</Link>}
      {next && <Link className={styles.links} href={{ pathname: '/', query: { page: next, q: searchTerm } }}>Próxima Página</Link>}
    </main>
  );
}